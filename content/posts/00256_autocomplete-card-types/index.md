...
The first design ran a CTE over `magic.cards` to unnest `card_types` and `card_subtypes` JSONB arrays and count occurrences ([`get_common_card_types.sql`](https://github.com/jbylund/arcane_tutor/blob/637c98052ba2c5ea41bef6f5f4db453585897765/api/sql/get_common_card_types.sql)):
...
[PR #545](https://github.com/jbylund/arcane_tutor/pull/545) made that switch: — the engine's deduplicated list of one preferred printing per oracle card:
...
([`index.html`, lines 8–34](https://github.com/jbylund/arcane_tutor/blob/d5239ab8dbabc01b2d93be8d13f4c816724cd267/api/static/index.html#L8-L34))
...
The second version ([`app.js`, lines 10–62](https://github.com/jbylund/arcane_tutor/blob/d5239ab8dbabc01b2d93be8d13f4c816724cd267/api/static/app.js#L10-L62)) is a sparse depth-3 prefix trie backed by a flat sorted array.
...
([`app.js`, lines 430–460](https://github.com/jbylund/arcane_tutor/blob/d5239ab8dbabc01b2d93be8d13f4c816724cd267/api/static/app.js#L430-L460))
